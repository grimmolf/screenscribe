...
echo ""
echo "Next steps:"
echo "1. Set up Fabric AI provider: fabric --setup"
echo "2. Test installation: scribe --help"
echo "3. Process your first video: scribe analyze video.mp4 | fabric -p analyze_video_content"